...
//NODE DEFINITIONS
#define SENSOR_ID         "CIEP-13"// NODE ID
...
#define N_SAMPLES         4          // NUMBER OF SAMPLES TO CONSIDERAR IN THE AVERAGE OF SAMPLES
...
const char apn[]      = "freeeway";//"freeeway"; //"internet.emt.ee"; // APN from PRIMCARDS
